...
public:
    ...
    /// Set mapping of compounds to their individual dilution steps.
    void setCompoundDilutions(const QMap<QString, int> &dilutions);
...
private:                                 /* helpers */
    ...
    int getDilution(const QString &compound) const;
...
private:                                 /* state */
    ...
    QMap<QString, int>     compoundDilutions_;
};
