...
private:            /* ---------- plate helpers ---------- */
    void populateDaughterPlates(const QMap<QString, int> &compoundDilutions,
                                int defaultDilutionSteps,
    ...
    /// Check feasibility of stock concentrations for starting concentrations.
