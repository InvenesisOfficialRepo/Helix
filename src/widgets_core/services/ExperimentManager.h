...
public:
    ...
    // Plate Calculations
    QList<QMap<QString, QStringList>> calculateInitialDaughterPlates(const QMap<QString, int>& compoundDilutions, const QStringList& compoundList, const QString& testType, bool is384) const;
